...
public class LuZip {
	...
	public static void main(String[] args) {	
		LuZip luz= new LuZip();
		luz.compress("./source/huffman/input.txt", "./source/huffman/output.txt");
		luz.decompress("./source/huffman/output.txt", "./source/huffman/decode.txt");
//		luz.compress("./source/huffman/input.gif", "./source/huffman/output.zip");
//		luz.decompress("./source/huffman/output.zip", "./source/huffman/decode.gif");
	}
